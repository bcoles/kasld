...
| `prefetch` | Daniel Gruss et al. (technique); Will (timing asm) | https://gruss.cc/files/prefetch.pdf | Implements the published technique; adapts the EntryBleed timing asm. |
| `avx_maskload` | Hyunwoo Choi, Suryeon Kim, Seungwon Shin | https://arxiv.org/abs/2304.07940 | Implements the published technique in KASLD's own code; no upstream code used. |
