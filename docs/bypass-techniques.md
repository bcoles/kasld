...
| AVX masked load/store timing | 2023 | — | Intel and AMD. Timing differences in the implementation of AVX masked load and store instructions infer whether an address is backed, breaking user-space ASLR, KASLR and SGX enclave ASLR. | [AVX Timing Side-Channel Attacks against Address Space Layout Randomization](https://arxiv.org/pdf/2304.07940) (Choi, Kim, Shin, 2023) — 60th DAC |
