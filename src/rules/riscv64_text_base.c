...
//
// Do NOT read this branch as proof of the modern layout and floor the image at
// KERNEL_LINK_ADDR on it. Q_PAGE_OFFSET is the engine's resolved direct-map
// estimate, not the kernel's CONFIG_PAGE_OFFSET, and the two disagree: a live
// 5.10 sv39 board — legacy layout, _stext at 0xffffffe000229000 — resolves
// Q_PAGE_OFFSET into the MODERN sv39 band (top 0xffffffd800000000, below the
// legacy floor). A floor at KERNEL_LINK_ADDR would have sat 126 GiB above the
