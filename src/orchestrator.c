...
/* =========================================================================
 * Post-processing: bounds validation, anchor selection, KASLR summary
 * =========================================================================
 *
 * What collection produced, turned into what the renderers read: every record
 * is checked against the runtime address space, one canonical record is chosen
 * per (type, region), the engine is resolved, and the slide and entropy the
 * summary carries are computed from it.
 */
